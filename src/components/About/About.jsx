      ...
      <div className="about-main">
        <div className="about-main-left">
          ...
          <p className="about-details">
            I am a web developer have a good knowledge in
            HTML,CSS,JavaScript,Jquery,bootstrap and
          ...
          <p className="about-details">
            Youtube is my passion, I provide free online courses and various
            training with free certificates!{" "}
            <a
